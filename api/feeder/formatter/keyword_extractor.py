...
def sanitize_string (string):
  ...
  filtered = filter_stopwords_from(parsed)
  return filtered

def clean_and_reduce_string_list (string_list):
  reduced = " ".join(list(map(lambda headline: remove_publication_after_pipe(headline), string_list)))
  filtered = filter_stopwords_from(reduced)
  return filtered

def filter_stopwords_from (string):
  ...
  filtered_keywords = [w for w in raw_word_tokens if not w in stop_words] # do not add stop words
